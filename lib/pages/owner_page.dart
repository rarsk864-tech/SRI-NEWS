                        ...
                        onPressed: saving ? null : () async {
                          ...
                          if (picked.length > 5 && context.mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Maximum 20 images can be selected.')),
                            );
                          }
                        },
                        icon: const Icon(Icons.collections_outlined),
                        label: Text(selectedImages.isEmpty ? 'Select up to 20 Images' : '${selectedImages.length} Images Selected'),
                      ),
