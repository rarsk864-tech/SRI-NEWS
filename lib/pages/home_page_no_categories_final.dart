...
class _HomePageState extends State<HomePage> {
  ...
  int nav = 0;
  // All news are shown on the single Read page.
...
class NewsDetailsPage extends StatelessWidget {
  ...
  String get displayDate {
    ...
    return item.time.isNotEmpty ? '$day/$month/${date.year} ${item.time}' : '$day/$month/${date.year}';
  }
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  if (item.publishedAt != null || item.time.isNotEmpty)
                    Text(
                      displayDate,
                      style: TextStyle(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Share feature will be connected next.'),
                        ),
                      );
                    },
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                            'Bookmark feature will be connected next.',
                          ),
                        ),
                      );
                    },
