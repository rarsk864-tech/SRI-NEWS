        ...
        Expanded(
          child: StreamBuilder<List<NewsItem>>(
            ...
            builder: (_, s) {
              ...
              // Show exactly one news item at a time. Swipe/scroll vertically
              // to move to the next news item; the second item must not be
              // visible underneath the first one.
        ...
        children: [
          Column(
              ...
              children: [
                ...
                // Show the article matter directly under the title.
                // Prefer the short description; if it is empty, use the full content.
                if (item.description.trim().isNotEmpty || item.content.trim().isNotEmpty)
                  Padding(
