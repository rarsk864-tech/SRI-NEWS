              ...
              child: SingleChildScrollView(child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                ...
                OutlinedButton.icon(
                  onPressed: saving ? null : () async {
                    ...
                    if (picked.length > 20 && context.mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Maximum 10 images can be selected.')));
                  },
                  icon: const Icon(Icons.collections_outlined),
                  label: Text(detailImages.isEmpty ? 'Select up to 10 Images' : '${detailImages.length} Images Selected'),
                ),
