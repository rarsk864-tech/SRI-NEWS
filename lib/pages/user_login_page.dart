  ...
  Future<void> forgotPassword() async {
    ...
    if (emailText.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Password reset కోసం ముందుగా email ఇవ్వండి.')),
      );
      return;
    }
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Password reset link మీ email కి పంపించాం.'),
        ),
      );
      ...
      final message = switch (e.code) {
        ...
        'user-not-found' => 'ఈ email తో account కనిపించలేదు.',
        _ => e.message ?? 'Password reset failed. మళ్లీ ప్రయత్నించండి.',
      };
