                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        value: tagController.text.isEmpty ? null : tagController.text,
                      ...
                      OutlinedButton.icon(
                        onPressed: saving ? null : () async {
                          ...
                          final files = picked.take(10).map((x) => File(x.path)).toList();
                          setSheetState(() { selectedImages..clear()..addAll(files); });
                          if (picked.length > 10 && context.mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Maximum 10 images can be selected.')),
                            );
                          }
                        },
                        icon: const Icon(Icons.collections_outlined),
                        label: Text(selectedImages.isEmpty ? 'Select up to 10 Images' : '${selectedImages.length} Images Selected'),
                      ),
