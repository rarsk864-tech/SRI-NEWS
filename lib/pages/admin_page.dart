...
class _AdminPageState extends State<AdminPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(title: const Text('SRI NEWS • ADMIN'), actions: [IconButton(tooltip: 'Profile Settings', onPressed: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const ProfileSettingsPage())), icon: const Icon(Icons.account_circle_outlined)), IconButton(onPressed: auth.logout, icon: const Icon(Icons.logout))]),
